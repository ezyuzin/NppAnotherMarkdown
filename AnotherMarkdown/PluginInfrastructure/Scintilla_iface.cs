...
{
  /// <summary>
  /// Compatible with Windows NMHDR. hwndFrom is really an environment specific window handle or pointer but most
  /// clients of Scintilla.h do not have this type visible.
  /// </summary>
  ...
  {
    /// <summary>
    /// SCN_STYLENEEDED, SCN_DOUBLECLICK, SCN_MODIFIED, SCN_MARGINCLICK, SCN_NEEDSHOWN, SCN_DWELLSTART, SCN_DWELLEND,
    /// SCN_CALLTIPCLICK, SCN_HOTSPOTCLICK, SCN_HOTSPOTDOUBLECLICK, SCN_HOTSPOTRELEASECLICK, SCN_INDICATORCLICK,
    /// SCN_INDICATORRELEASE, SCN_USERLISTSELECTION, SCN_AUTOCSELECTION
    /// </summary>
    public Position Position {
      get { return new Position(position.ToInt32()); }
    }
    /// <summary>
    /// Character of the notification - eg keydown SCN_CHARADDED, SCN_KEY, SCN_AUTOCCOMPLETE, SCN_AUTOCSELECTION,
    /// SCN_USERLISTSELECTION
    /// </summary>
    public char Character {
      get { return (char) character; }
    }
  ...
  public class TextToFind : IDisposable
  {
    ...
    {
      if (_sciTextToFind.lpstrText != IntPtr.Zero) {
        Marshal.FreeHGlobal(_sciTextToFind.lpstrText);
      }
    }
    ...
    public void Dispose()
    {
      if (!_disposed) {
        _freeNativeString();
        if (_ptrSciTextToFind != IntPtr.Zero) {
          Marshal.FreeHGlobal(_ptrSciTextToFind);
        }
