...
namespace Kbg.NppPluginNET.PluginInfrastructure
{
  ...
  /// <summary>
  /// This class holds helpers for sending messages defined in the Msgs_h.cs file. It is at the moment incomplete.
  ...
  public class NotepadPPGateway : INotepadPPGateway
  {
    ...
    /// <summary>
    /// This method incapsulates a common pattern in the Notepad++ API: when you need to retrieve a string, you can
    /// first query the buffer size. This method queries the necessary buffer size, allocates the temporary memory, then
    /// returns the string retrieved through that buffer.
    /// </summary>
    ...
    public string GetNppPath() => GetString(NppMsg.NPPM_GETNPPDIRECTORY);

    /// <returns>The path to the Config folder for plugins.</returns>
    public string GetPluginConfigPath() => GetString(NppMsg.NPPM_GETPLUGINSCONFIGDIR);
    ...
    public bool OpenFile(string path) => Win32.SendMessage(
				PluginBase.nppData._nppHandle, (uint) NppMsg.NPPM_DOOPEN, Unused, path)
      .ToInt32() != 0;
  ...
  /// <summary>
  /// This class holds helpers for sending messages defined in the Resource_h.cs file. It is at the moment incomplete.
  /// Please help fill in the blanks.
  /// </summary>
  class NppResource
  {
