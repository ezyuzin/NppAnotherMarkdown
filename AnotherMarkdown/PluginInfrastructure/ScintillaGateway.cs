...
{
  /// <summary>
  /// This it the plugin-writers primary interface to Notepad++/Scintilla. It takes away all the complexity with command
  /// numbers and Int-pointer casting.  See http://www.scintilla.org/ScintillaDoc.html for further details.
  /// </summary>
  public class ScintillaGateway : IScintillaGateway
  {
    ...
    /// <summary>
    /// Remember the current position in the undo history as the position at which the document was saved. (Scintilla
    /// feature 2014)
    /// </summary>
    ...
    /// <summary>
    /// Retrieve a buffer of cells. Returns the number of bytes in the buffer not including terminating NULs. (Scintilla
    /// feature 2015)
    /// </summary>
    ...
    /// <summary>
    /// Find the position from a point within the window but return INVALID_POSITION if not close to text. (Scintilla
    /// feature 2023)
    /// </summary>
    ...
    /// <summary>
    /// Retrieve the text of the line containing the caret. Returns the index of the caret on the line. Result is NUL-
    /// terminated. (Scintilla feature 2027)
    /// </summary>
    ...
    /// <summary>
    /// Change style from current styling position for length characters to a style and move the current styling
    /// position to after this newly styled segment. (Scintilla feature 2033)
    /// </summary>
    ...
    /// <summary>
    /// If drawing is buffered then each line of text is drawn into a bitmap buffer before drawing it to the screen to
    /// avoid flicker. (Scintilla feature 2035)
    /// </summary>
    ...
    /// enter Unicode mode. (Scintilla feature 2037)
    /// </summary>
    ...
    /// <summary>
    /// Set the background colour used for a particular marker number when its folding block is selected. (Scintilla
    /// feature 2292)
    /// </summary>
    ...
    /// <summary>
    /// Enable/disable highlight for current folding bloc (smallest one that contains the caret) (Scintilla feature
    /// 2293)
    /// </summary>
    ...
    /// <summary>
    /// Set the foreground colour of the main and additional selections and whether to use this setting. (Scintilla
    /// feature 2067)
    /// </summary>
    ...
    /// <summary>
    /// Set the background colour of the main and additional selections and whether to use this setting. (Scintilla
    /// feature 2068)
    /// </summary>
    ...
    /// <summary>
    /// Set the set of characters making up words for when moving or selecting by word. First sets defaults like
    /// SetCharsDefault. (Scintilla feature 2077)
    /// </summary>
    ...
    /// <summary>
    /// Display the caret line framed. Set width != 0 to enable this option and width = 0 to disable it. (Scintilla
    /// feature 2705)
    /// </summary>
    ...
    /// <summary>
    /// Display a auto-completion list. The lengthEntered parameter indicates how many characters before the caret
    /// should be used to provide context. (Scintilla feature 2100)
    /// </summary>
    ...
    /// <summary>
    /// Change the separator character in the string setting up an auto-completion list. Default is space but can be
    /// changed if items contain space. (Scintilla feature 2106)
    /// </summary>
    ...
    /// <summary>
    /// Should the auto-completion list be cancelled if the user backspaces to a position before where the box was
    /// created. (Scintilla feature 2110)
    /// </summary>
    ...
    /// <summary>
    /// Define a set of characters that when typed will cause the autocompletion to choose the selected item. (Scintilla
    /// feature 2112)
    /// </summary>
    ...
    /// <summary>
    /// Change the type-separator character in the string setting up an auto-completion list. Default is '?' but can be
    /// changed if items contain '?'. (Scintilla feature 2286)
    /// </summary>
    ...
    /// <summary>
    /// Set the maximum width, in characters, of auto-completion and user lists. Set to 0 to autosize to fit longest
    /// item, which is the default. (Scintilla feature 2208)
    /// </summary>
    ...
    /// <summary>
    /// Set the maximum height, in rows, of auto-completion and user lists. The default is 5 rows. (Scintilla feature
    /// 2210)
    /// </summary>
    ...
    /// <summary>
    /// Indentation will only use space characters if useTabs is false, otherwise it will use a combination of tabs and
    /// spaces. (Scintilla feature 2124)
    /// </summary>
    ...
    /// the secondary position. This may be used to make a search match visible. (Scintilla feature 2569)
    /// </summary>
    ...
    /// <summary>
    /// Sets the position that starts the target which is used for updating the document without affecting the scroll
    /// position. (Scintilla feature 2190)
    /// </summary>
    ...
    /// <summary>
    /// Sets the position that ends the target which is used for updating the document without affecting the scroll
    /// position. (Scintilla feature 2192)
    /// </summary>
    ...
    /// <summary>
    /// Replace the target text with the argument text. Text is counted so it can contain NULs. Returns the length of
    /// the replacement text. (Scintilla feature 2194)
    /// </summary>
    ...
    /// Looks for \d where d is between 1 and 9 and replaces these with the strings matched in the last search operation
    /// which were surrounded by \( and \). Returns the length of the replacement text including any change caused by
    /// processing the \d patterns. (Scintilla feature 2195)
    /// </summary>
    ...
    /// <summary>
    /// Search for a counted string in the target and set the target to the found range. Text is counted so it can
    /// contain NULs. Returns start of found range or -1 for failure in which case target is not moved. (Scintilla
    /// feature 2197)
    /// </summary>
    ...
    /// <summary>
    /// Set the fold level of a line. This encodes an integer level along with flags indicating whether the line is a
    /// header and whether it is effectively white space. (Scintilla feature 2222)
    /// </summary>
    ...
    /// <summary>
    /// Expand a fold header and all children. Use the level argument instead of the line's current level. (Scintilla
    /// feature 2239)
    /// </summary>
    ...
    /// <summary>
    /// Ensure a particular line is visible by expanding any header line hiding it. Use the currently set visibility
    /// policy to determine which range to display. (Scintilla feature 2234)
    /// </summary>
    ...
    /// control characters. (Scintilla feature 2276)
    /// </summary>
    ...
    /// Setting this to false allows scrolling one page below the last line. (Scintilla feature 2277)
    /// </summary>
    ...
    /// <summary>
    /// Retrieve whether the maximum scroll position has the last line at the bottom of the view. (Scintilla feature
    /// 2278)
    /// </summary>
    ...
    /// <summary>
    /// In one phase draw, text is drawn in a series of rectangular blocks with no overlap. In two phase draw, text is
    /// drawn in a series of lines allowing runs to overlap horizontally. In multiple phase draw, each element is drawn
    /// over the whole drawing area, allowing text to overlap from one line to the next. (Scintilla feature 2674)
    /// </summary>
    ...
    /// <summary>
    /// Split the lines in the target into lines that are less wide than pixelWidth where possible. (Scintilla feature
    /// 2289)
    /// </summary>
    ...
    /// <summary>
    /// If selection is empty or all on one line replace the selection with a tab character. If more than one line
    /// selected, indent the lines. (Scintilla feature 2327)
    /// </summary>
    public void Tab()
    {
    ...
    /// <summary>
    /// Delete the selection or if no selection, the character before the caret. Will not delete the character before at
    /// the start of a line. (Scintilla feature 2344)
    /// </summary>
    ...
    /// <summary>
    /// Like Home but when word-wrap is enabled goes first to start of display line HomeDisplay, then to start of
    /// document line Home. (Scintilla feature 2349)
    /// </summary>
    ...
    /// <summary>
    /// Like HomeExtend but when word-wrap is enabled extends first to start of display line HomeDisplayExtend, then to
    /// start of document line HomeExtend. (Scintilla feature 2450)
    /// </summary>
    ...
    /// <summary>
    /// Like LineEnd but when word-wrap is enabled goes first to end of display line LineEndDisplay, then to start of
    /// document line LineEnd. (Scintilla feature 2451)
    /// </summary>
    ...
    /// <summary>
    /// Like LineEndExtend but when word-wrap is enabled extends first to end of display line LineEndDisplayExtend, then
    /// to start of document line LineEndExtend. (Scintilla feature 2452)
    /// </summary>
    ...
    /// <summary>
    /// Like VCHome but when word-wrap is enabled goes first to start of display line VCHomeDisplay, then behaves like
    /// VCHome. (Scintilla feature 2453)
    /// </summary>
    ...
    /// <summary>
    /// Like VCHomeExtend but when word-wrap is enabled extends first to start of display line VCHomeDisplayExtend, then
    /// behaves like VCHomeExtend. (Scintilla feature 2454)
    /// </summary>
    ...
    /// <summary>
    /// Find the position of a matching brace or INVALID_POSITION if no match. The maxReStyle must be 0 for now. It may
    /// be defined in a future release. (Scintilla feature 2353)
    /// </summary>
    ...
    /// <summary>
    /// The edge may be displayed by a line (EDGE_LINE/EDGE_MULTILINE) or by highlighting text that goes beyond it
    /// (EDGE_BACKGROUND) or not displayed at all (EDGE_NONE). (Scintilla feature 2363)
    /// </summary>
    ...
    /// <summary>
    /// Set whether a pop up menu is displayed automatically when the user presses the wrong mouse button on certain
    /// areas. (Scintilla feature 2371)
    /// </summary>
    ...
    /// <summary>
    /// Set the zoom level. This number of points is added to the size of all fonts. It may be positive to magnify or
    /// negative to reduce. (Scintilla feature 2373)
    /// </summary>
    ...
    /// <summary>
    /// Create a new document object. Starts with reference count of 1 and not selected into editor. (Scintilla feature
    /// 2375)
    /// </summary>
    ...
    /// <summary>
    /// Change the way control characters are displayed: If symbol is < 32, keep the drawn way, else, use the given
    /// character. (Scintilla feature 2388)
    /// </summary>
    ...
    /// <summary>
    /// Move to the previous change in capitalisation extending selection to new caret position. (Scintilla feature
    /// 2391)
    /// </summary>
    ...
    /// <summary>
    /// Set the way the display area is determined when a particular line is to be moved to by Find, FindNext, GotoLine,
    /// etc. (Scintilla feature 2394)
    /// </summary>
    ...
    /// <summary>
    /// Set the way the caret is kept visible when going sideways. The exclusion zone is given in pixels. (Scintilla
    /// feature 2402)
    /// </summary>
    ...
    /// <summary>
    /// Set the way the line the caret is on is kept visible. The exclusion zone is given in lines. (Scintilla feature
    /// 2403)
    /// </summary>
    ...
    /// <summary>
    /// Given a valid document position, return the previous position taking code page into account. Returns 0 if passed
    /// 0. (Scintilla feature 2417)
    /// </summary>
    ...
    /// <summary>
    /// Given a valid document position, return the next position taking code page into account. Maximum value returned
    /// is the last position in the document. (Scintilla feature 2418)
    /// </summary>
    ...
    /// <summary>
    /// Given a valid document position, return a position that differs in a number of characters. Returned value is
    /// always between 0 and last position in document. (Scintilla feature 2670)
    /// </summary>
    ...
    /// <summary>
    /// Given a valid document position, return a position that differs in a number of UTF-16 code units. Returned value
    /// is always between 0 and last position in document. The result may point half way (2 bytes) inside a non-BMP
    /// character. (Scintilla feature 2716)
    /// </summary>
    ...
    /// <summary>
    /// Set the selection mode to stream (SC_SEL_STREAM) or rectangular (SC_SEL_RECTANGLE/SC_SEL_THIN) or by lines
    /// (SC_SEL_LINES). (Scintilla feature 2422)
    /// </summary>
    ...
    /// <summary>
    /// Retrieve the position of the start of the selection at the given line (INVALID_POSITION if no selection on this
    /// line). (Scintilla feature 2424)
    /// </summary>
    ...
    /// <summary>
    /// Retrieve the position of the end of the selection at the given line (INVALID_POSITION if no selection on this
    /// line). (Scintilla feature 2425)
    /// </summary>
    ...
    /// <summary>
    /// Move caret to first position on line, extending rectangular selection to new caret position. (Scintilla feature
    /// 2430)
    /// </summary>
    ...
    /// <summary>
    /// Move caret to before first visible character on line. If already there move to first character on line. In
    /// either case, extend rectangular selection to new caret position. (Scintilla feature 2431)
    /// </summary>
    ...
    /// <summary>
    /// Move caret to last position on line, extending rectangular selection to new caret position. (Scintilla feature
    /// 2432)
    /// </summary>
    ...
    /// <summary>
    /// Move caret to bottom of page, or one page down if already at bottom of page, extending selection to new caret
    /// position. (Scintilla feature 2438)
    /// </summary>
    ...
    /// <summary>
    /// Move caret left one word, position cursor at end of word, extending selection to new caret position. (Scintilla
    /// feature 2440)
    /// </summary>
    ...
    /// <summary>
    /// Move caret right one word, position cursor at end of word, extending selection to new caret position. (Scintilla
    /// feature 2442)
    /// </summary>
    ...
    /// SetWordChars. (Scintilla feature 2443)
    /// </summary>
    ...
    /// <summary>
    /// Set the set of characters making up punctuation characters Should be called after SetWordChars. (Scintilla
    /// feature 2648)
    /// </summary>
    ...
    /// terminated. (Scintilla feature 2610)
    /// </summary>
    ...
    /// <summary>
    /// Set the length of the utf8 argument for calling EncodedFromUTF8. Set to -1 and the string will be measured to
    /// the first nul. (Scintilla feature 2448)
    /// </summary>
    ...
    /// <summary>
    /// Translates a UTF8 string into the document encoding. Return the length of the result in bytes. On error return
    /// 0. (Scintilla feature 2449)
    /// </summary>
    ...
    /// <summary>
    /// Find the position of a column on a line taking into account tabs and multi-byte characters. If beyond end of
    /// line, return line end position. (Scintilla feature 2456)
    /// </summary>
    ...
    /// <summary>
    /// Compact the document buffer and return a read-only pointer to the characters in the document. (Scintilla feature
    /// 2520)
    /// </summary>
    ...
    /// contiguous, but will only move up to lengthRange bytes. (Scintilla feature 2643)
    /// </summary>
    ...
    /// <summary>
    /// Return a position which, to avoid performance costs, should not be within the range of a call to
    /// GetRangePointer. (Scintilla feature 2644)
    /// </summary>
    ...
    /// <summary>
    /// On GTK, allow selecting the modifier key to use for mouse-based rectangular selection. Often the window manager
    /// requires Alt+Mouse Drag for moving windows. Valid values are SCMOD_CTRL(default), SCMOD_ALT, or SCMOD_SUPER.
    ...
    /// <summary>
    /// Set the foreground colour of additional selections. Must have previously called SetSelFore with non-zero first
    /// argument for this to have an effect. (Scintilla feature 2600)
    /// </summary>
    ...
    /// <summary>
    /// Set the background colour of additional selections. Must have previously called SetSelBack with non-zero first
    /// argument for this to have an effect. (Scintilla feature 2601)
    /// </summary>
    ...
    /// <summary>
    /// Add the next occurrence of the main selection to the set of selections as main. If the current selection is
    /// empty then select word around caret. (Scintilla feature 2688)
    /// </summary>
    ...
    /// <summary>
    /// Add each occurrence of the main selection in the target to the set of selections. If the current selection is
    /// empty then select word around caret. (Scintilla feature 2689)
    /// </summary>
    ...
    /// <summary>
    /// Indicate that the internal state of a lexer has changed over a range and therefore there may be a need to
    /// redraw. (Scintilla feature 2617)
    /// </summary>
    ...
    /// <summary>
    /// Define a marker from RGBA data. It has the width and height from RGBAImageSetWidth/Height (Scintilla feature
    /// 2626)
    /// </summary>
    ...
    /// <summary>
    /// Register an RGBA image for use in autocompletion lists. It has the width and height from
    /// RGBAImageSetWidth/Height (Scintilla feature 2627)
    /// </summary>
    ...
    /// <summary>
    /// Move caret to before first visible character on display line. If already there move to first character on
    /// display line. (Scintilla feature 2652)
    /// </summary>
    ...
    /// encoding. (Scintilla feature 2656)
    /// </summary>
    ...
    /// Result is NUL-terminated. (Scintilla feature 4009)
    /// </summary>
    ...
    /// <summary>
    /// Retrieve a "property" value previously set with SetProperty, interpreted as an int AFTER any "$()" variable
    /// replacement. (Scintilla feature 4010)
    /// </summary>
    ...
    /// <summary>
    /// Retrieve the name of the lexer. Return the length of the text. Result is NUL-terminated. (Scintilla feature
    /// 4012)
    /// </summary>
    ...
    /// <summary>
    /// Retrieve a '\n' separated list of descriptions of the keyword sets understood by the current lexer. Result is
    /// NUL-terminated. (Scintilla feature 4017)
    /// </summary>
    ...
    /// <summary>
    /// Bit set of LineEndType enumertion for which line ends beyond the standard LF, CR, and CRLF are supported by the
    /// lexer. (Scintilla feature 4018)
    /// </summary>
    ...
    /// <summary>
    /// Get the set of base styles that can be extended with sub styles Result is NUL-terminated. (Scintilla feature
    /// 4026)
    /// </summary>
    ...
    /// <summary>
    /// Retrieve a ' ' separated list of style tags like "literal quoted string". Result is NUL-terminated. (Scintilla
    /// feature 4031)
    /// </summary>
    ...
    /// <summary>
    /// Retrieve bidirectional text display state. (Scintilla feature 2708)
    /// </summary>
    ...
    /// <summary>
    /// Set bidirectional text display state. (Scintilla feature 2709)
    /// </summary>
    ...
    /// <summary>
    /// Divide each styling byte into lexical class bits (default: 5) and indicator bits (default: 3). If a lexer
    /// requires more than 32 lexical states, then this is used to expand the possible states. (Scintilla feature 2090)
    /// </summary>
    ...
    /// <summary>
    /// Deprecated in 3.5.5 Always interpret keyboard input as Unicode (Scintilla feature 2521)
    /// </summary>
    ...
    /// <summary>
    /// In twoPhaseDraw mode, drawing is performed in two phases, first the background and then the foreground. This
    /// avoids chopping off characters that overlap the next run. (Scintilla feature 2284)
    /// </summary>
