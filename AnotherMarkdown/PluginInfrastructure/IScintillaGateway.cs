...
namespace Kbg.NppPluginNET.PluginInfrastructure
{
  ...
  public interface IScintillaGateway
  {
    ...
    /// <summary>
    /// Set the selection anchor to a position. The anchor is the opposite end of the selection from the caret. (Scintilla
    /// feature 2026)
    /// </summary>
    ...
    /// <summary>
    /// Set the current styling position to start. The unused parameter is no longer used and should be set to 0. (Scintilla
    /// feature 2032)
    /// </summary>
    ...
    /// after this newly styled segment. (Scintilla feature 2033)
    /// </summary>
    ...
    /// flicker. (Scintilla feature 2035)
    /// </summary>
    ...
    /// <summary>
    /// Set the background colour used for a particular marker number when its folding block is selected. (Scintilla feature
    /// 2292)
    /// </summary>
    ...
    /// <summary>
    /// Find the next line at or after lineStart that includes a marker in mask. Return -1 when no more lines. (Scintilla
    /// feature 2047)
    /// </summary>
    ...
    /// <summary>
    /// Set the foreground colour of the main and additional selections and whether to use this setting. (Scintilla feature
    /// 2067)
    /// </summary>
    void SetSelFore(bool useSetting, Colour fore);

    /// <summary>
    /// Set the background colour of the main and additional selections and whether to use this setting. (Scintilla feature
    /// 2068)
    /// </summary>
    ...
    /// <summary>
    /// Display the caret line framed. Set width != 0 to enable this option and width = 0 to disable it. (Scintilla feature
    /// 2705)
    /// </summary>
    ...
    /// <summary>
    /// Change the separator character in the string setting up an auto-completion list. Default is space but can be changed
    /// if items contain space. (Scintilla feature 2106)
    /// </summary>
    ...
    /// <summary>
    /// Set whether or not autocompletion deletes any word characters after the inserted text upon completion. (Scintilla
    /// feature 2270)
    /// </summary>
    ...
    /// <summary>
    /// Set the maximum width, in characters, of auto-completion and user lists. Set to 0 to autosize to fit longest item,
    /// which is the default. (Scintilla feature 2208)
    /// </summary>
    ...
    /// <summary>
    /// Scroll the argument positions and the range between them into view giving priority to the primary position then the
    /// secondary position. This may be used to make a search match visible. (Scintilla feature 2569)
    /// </summary>
    ...
    /// and whether it is effectively white space. (Scintilla feature 2222)
    /// </summary>
    ...
    /// <summary>
    /// Ensure a particular line is visible by expanding any header line hiding it. Use the currently set visibility policy
    /// to determine which range to display. (Scintilla feature 2234)
    /// </summary>
    ...
    /// this to false allows scrolling one page below the last line. (Scintilla feature 2277)
    /// </summary>
    ...
    /// <summary>
    /// In one phase draw, text is drawn in a series of rectangular blocks with no overlap. In two phase draw, text is drawn
    /// in a series of lines allowing runs to overlap horizontally. In multiple phase draw, each element is drawn over the
    /// whole drawing area, allowing text to overlap from one line to the next. (Scintilla feature 2674)
    /// </summary>
    ...
    /// indent the lines. (Scintilla feature 2327)
    /// </summary>
    void Tab();
    ...
    /// <summary>
    /// Move caret to before first visible character on line. If already there move to first character on line. (Scintilla
    /// feature 2331)
    /// </summary>
    void VCHome();
    ...
    /// start of a line. (Scintilla feature 2344)
    /// </summary>
    ...
    /// <summary>
    /// Like Home but when word-wrap is enabled goes first to start of display line HomeDisplay, then to start of document
    /// line Home. (Scintilla feature 2349)
    /// </summary>
    void HomeWrap();
    ...
    /// <summary>
    /// Like LineEndExtend but when word-wrap is enabled extends first to end of display line LineEndDisplayExtend, then to
    /// start of document line LineEndExtend. (Scintilla feature 2452)
    /// </summary>
    ...
    /// <summary>
    /// Find the position of a matching brace or INVALID_POSITION if no match. The maxReStyle must be 0 for now. It may be
    /// defined in a future release. (Scintilla feature 2353)
    /// </summary>
    ...
    /// <summary>
    /// Set the way the caret is kept visible when going sideways. The exclusion zone is given in pixels. (Scintilla feature
    /// 2402)
    /// </summary>
    ...
    /// <summary>
    /// Given a valid document position, return the next position taking code page into account. Maximum value returned is
    /// the last position in the document. (Scintilla feature 2418)
    /// </summary>
    int PositionAfter(int pos);

    /// <summary>
    /// Given a valid document position, return a position that differs in a number of characters. Returned value is always
    /// between 0 and last position in document. (Scintilla feature 2670)
    /// </summary>
    int PositionRelative(int pos, int relative);

    /// <summary>
    /// Given a valid document position, return a position that differs in a number of UTF-16 code units. Returned value is
    /// always between 0 and last position in document. The result may point half way (2 bytes) inside a non-BMP character.
    ...
    /// <summary>
    /// Move caret to before first visible character on line. If already there move to first character on line. In either
    /// case, extend rectangular selection to new caret position. (Scintilla feature 2431)
    /// </summary>
    ...
    /// <summary>
    /// Set the length of the utf8 argument for calling EncodedFromUTF8. Set to -1 and the string will be measured to the
    /// first nul. (Scintilla feature 2448)
    /// </summary>
    ...
    /// <summary>
    /// Find the position of a column on a line taking into account tabs and multi-byte characters. If beyond end of line,
    /// return line end position. (Scintilla feature 2456)
    /// </summary>
    ...
    /// <summary>
    /// Add the next occurrence of the main selection to the set of selections as main. If the current selection is empty
    /// then select word around caret. (Scintilla feature 2688)
    /// </summary>
    void MultipleSelectAddNext();

    /// <summary>
    /// Add each occurrence of the main selection in the target to the set of selections. If the current selection is empty
    /// then select word around caret. (Scintilla feature 2689)
    /// </summary>
    ...
    /// <summary>
    /// Move caret to before first visible character on display line. If already there move to first character on display
    /// line. (Scintilla feature 2652)
    /// </summary>
    void VCHomeDisplay();
    ...
    /// <summary>
    /// Divide each styling byte into lexical class bits (default: 5) and indicator bits (default: 3). If a lexer requires
    /// more than 32 lexical states, then this is used to expand the possible states. (Scintilla feature 2090)
    /// </summary>
    ...
    /// chopping off characters that overlap the next run. (Scintilla feature 2284)
    /// </summary>
